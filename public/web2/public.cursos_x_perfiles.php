 ...
 */
    ...
    class public_cursos_x_perfilesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('cod_curso', 'public.cursos_disponibles', new IntegerField('cod_curso'), new StringField('titulo', 'cod_curso_titulo', 'cod_curso_titulo_public_cursos_disponibles'), 'cod_curso_titulo_public_cursos_disponibles');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('public_cursos_x_perfilesssearch', $this->dataset,
                array('cod_curso_titulo', 'perfil_estado', 'fecha_fin', 'lugar'),
                array($this->RenderText('Cod Curso'), $this->RenderText('Perfil'), $this->RenderText('Fecha Fin'), $this->RenderText('Lugar')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('public_cursos_x_perfilesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('cod_curso', $this->RenderText('Cod Curso'), $lookupDataset, 'cod_curso', 'titulo', false));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('cod_curso_titulo', 'Cod Curso', $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'public_cursos_x_perfiles_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }
    
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'public_cursos_x_perfilesGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new public_cursos_x_perfilesPage("public.cursos_x_perfiles.php", "public_cursos_x_perfiles", GetCurrentUserGrantForDataSource("public.cursos_x_perfiles"), 'UTF-8');
        $Page->SetShortCaption('Public.Cursos X Perfiles');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Public.Cursos X Perfiles');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("public.cursos_x_perfiles"));
