...
SELECT pg_catalog.setval('administradores_administrador_seq', 1, false);
...
SELECT pg_catalog.setval('archivos_archivo_seq', 1, false);
...
SELECT pg_catalog.setval('carreras_adm_carrera_seq', 1, false);
...
SELECT pg_catalog.setval('perfiles_perfil_seq', 1, false);
...
SELECT pg_catalog.setval('requerimientos_requerimiento_seq', 1, false);
...
SELECT pg_catalog.setval('users_usuario_seq', 1, false);
